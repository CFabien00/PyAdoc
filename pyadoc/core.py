...
class DocstringsDocumentCreator:
    ...
    output_file = "PyDoc.adoc"
    no_docstring = "_No docstring_"
    coma_space = ", "

    def __init__(self, input_dir: str, output_dir: str, toclevels: Optional[int] = 3):
        self.toclevels = toclevels
        self.input_dir = input_dir
        self.output_dir = output_dir
        self.output_file_path = f"{self.output_dir}/{self.output_file}"

    def create_docstring_doc(self) -> str:
        ...
        return self._write_to_adoc(project_data)

    # region _get

    @staticmethod
    def _get_args(node: ast.FunctionDef | ast.AsyncFunctionDef) -> List:
    ...
    def _extract_docstrings_from_project(self) -> Dict:
    ...
    def _extract_docstrings_from_file(self, py_file_path: str) -> Tuple[Dict, Dict]:
    ...
    def _write_to_adoc(self, project_data: Dict) -> str:
        ...
        with open(self.output_file_path, "w+", encoding="utf-8") as file:
            ...
            for file_path, content in sorted(project_data.items()):
                ...
                file.write(f"== {file_path.split(self.input_dir)[-1]}\n\n")
